...
export const WIDGETS: WidgetDef[] = [
  ...
  { id: 'funding', title: 'CSIL funding', description: 'Monthly funded-hours usage and projection.', category: 'Time & pay', roles: ['manager'], defaultSize: 'full' },
  { id: 'review', title: 'Awaiting your review', description: 'Completed work waiting for manager approval.', category: 'Tasks', roles: ['manager'], defaultSize: 'full' },
  { id: 'certs', title: 'Certification alerts', description: 'Expired or expiring care worker certifications.', category: 'Team', roles: ['manager'], defaultSize: 'full' },
  ...
  { id: 'activity', title: 'Recent activity', description: 'Latest household actions across tasks, team, and settings.', category: 'Activity', roles: ['manager'], defaultSize: 'full' },
  { id: 'quickactions', title: 'Quick actions', description: 'Jump straight to common manager tasks.', category: 'At a glance', roles: ['manager'], defaultSize: 'full' },
