          ...
          <div className="relative mx-auto grid w-full max-w-screen-2xl items-center gap-10 px-5 pb-14 pt-9 sm:px-10 sm:pt-14 lg:grid-cols-[1.05fr_1fr] lg:gap-14 lg:pb-20">
            <div>
              ...
              <div className="lp-fade-up mt-8 flex flex-col items-start gap-4" style={{ '--d': '0.3s' } as React.CSSProperties}>
                {signedIn ? <Link href="/dashboard" className={primaryClass}>Open your dashboard<ArrowRight className="size-4" aria-hidden="true" /></Link> : googleEnabled ? <form action={googleSignIn} className="w-full sm:w-auto"><button type="submit" className={primaryClass}><LogIn className="size-4" aria-hidden="true" />Sign in to your account<ArrowRight className="size-4" aria-hidden="true" /></button></form> : <Link href="/sign-in" className={primaryClass}>Sign in to your care team<ArrowRight className="size-4" aria-hidden="true" /></Link>}
