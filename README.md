...
- **CSIL records and continuity**: encrypted receipt capture with OCR, CSV/OFX bank reconciliation imports, reimbursement approvals, consent and retention records, an emergency backup-care plan, configurable authority mappings, and downloadable year-end packages.
