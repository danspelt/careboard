...
export const householdSettings = sqliteTable('household_settings', {
  ...
  csilHealthAuthority: text('csil_health_authority').notNull().default(''),
  csilAgreementStart: text('csil_agreement_start'),
  csilAgreementEnd: text('csil_agreement_end'),
  csilClientContribution: real('csil_client_contribution').notNull().default(0),
  csilReportDueDays: integer('csil_report_due_days').notNull().default(45),
  csilAccountLastFour: text('csil_account_last_four').notNull().default(''),
  csilContactName: text('csil_contact_name').notNull().default(''),
  csilContactEmail: text('csil_contact_email').notNull().default(''),
